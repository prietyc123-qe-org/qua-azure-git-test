...
export GITOPS_REPO_URL=https://github.com/prietyc123-qe-org/qua-azure-git-test-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-rhtap-tas.apps.cluster-hwxjs.hwxjs.sandbox3297.opentlc.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-rhtap-tas.apps.cluster-hwxjs.hwxjs.sandbox3297.opentlc.com}
